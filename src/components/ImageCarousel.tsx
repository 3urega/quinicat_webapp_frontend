      ...
      {images.map((src, index) => (
        ...
        >
          <Image
            ...
            unoptimized
          />
          {/* Capa de difuminado para mejorar la legibilidad del texto */}
          <div className="absolute inset-0 bg-gradient-to-b from-green-900/80 to-gray-900/80 backdrop-blur-sm"></div>
        </div>
      ))}
    </div>
  );
